                  ...
                  <Row gutter={[8, 0]} key={key}>
                    ...
                    <Col span={12}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Vui lòng nhập giá dự tính",
                          },
                        ]}
                      ...
                      >
                        <InputNumber
                          min={0}
                          className="w-full"
                          placeholder="Giá dự tính(1 chiếc,cái...)"
                         onChange={(v) =>{
                    ...
                    <Col span={12}>
                      <Form.Item
                        ...
                        name={[name, "quantity"]}
                        rules={[
                          { required: true, message: "Vui long nhập số lượng" },
                        ]}
                        label="Số lượng cần(VD: 1 cái)"
                      >
                        <InputNumber
                        min={0}
                        className="w-full"
                        placeholder="Số lượng cần(VD: 1 cái)"
                        onChange={(v) => {
                    ...
                    <Col span={24}>
                      <Form.Item
                        label="Thông số, đặc điểm"
                        rules={[
                          {
                            required: true,
                            message: "Vui lòng nhập thông số, đặc điểm",
                          },
                        ]}
                        {...restField}
