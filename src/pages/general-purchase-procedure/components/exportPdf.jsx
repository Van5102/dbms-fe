    ...
    <>
      <View style={styles.table}>
        <View style={styles.tableRow}>
          ...
          <TabCol width={80}>
            <Text>Giá dự tính(1 chiếc,...)	</Text>
          </TabCol>
          <TabCol width={30}>
            <Text>Số lượng tồn</Text>
          </TabCol>
          <TabCol width={70}>
            <Text>Tổng tiền	</Text>
          </TabCol>
        ...
        {data?.map((item, index) => (
          <View key={item?.id} style={styles.tableRow}>
            ...
            <TabCol width={100}>
              <Text renderText={handleRenderText}>{item?.specifications}</Text>
            </TabCol>
            ...
            <TabCol width={70}>
              <Text>{formatCurrency(item?.estimated_price * item?.quantity) }</Text>
            </TabCol>
            <TabCol width={80}>
